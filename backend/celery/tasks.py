...
from celery.utils import extract_text_from_url, extract_metadata
...
def decision_processing_task(self, url: str, decision_id: str):
    ...
    try:
        ...
        documents = [
            Document(
                ...
                metadata={
                    ...
                    "proceeding_number": decision_metadata.proceeding,
                    "decision_date": decision_metadata.date,
                }
            )
            for chunk in chunks
        ]
        ...
        embedding_fn = SentenceTransformerEmbeddings(model_name="sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2")
